...
몇 가지 기능을 추가해서 좀 더 높은 수준의 문제를 만들어보고 싶습니다. 예컨대, 토플 시험처럼 문제를 만들고 싶습니다. 
내가 문제를 맞추거나 틀리는 것에 따라 다음 문제의 난이도도 조정하는 기능도 추가해보고 싶습니다. 
...
틀렸음에도 더 어려운 문제가 나와 난이도 조절에 실패한 모습
{:style="text-align:center; opacity: 0.60; margin-bottom:30px; font-size: 12px"}
